""" 
GOAL: HOW MANY PRE-TARIFF IPPS ARE WITHIN FOUR YEARS OF TARIFF
...
# Import pre-tariff ISP pop data

preTariffIPPs = pd.read_sas("s3://alpha-omppg/ISP Population/Final Datasets/isp_pop_2024q1.sas7bdat",encoding = 'latin1')
