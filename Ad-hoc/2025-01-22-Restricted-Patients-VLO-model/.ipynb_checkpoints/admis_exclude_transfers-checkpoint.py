...
admis = admis[~admis['AUTHORITY_FOR_DETENTION_DESCRIPTION'].str.contains('Xfer from',case=False,na=False)]
...
admis_off[admis_off['COURT_OFFENCE_TEXT'].str.contains('drug|theft|suspended|prevent', case=False, na=False)]['COURT_OFFENCE_TEXT'].value_counts(dropna=False)

admis_off = admis_off[~admis_off['COURT_OFFENCE_TEXT'].str.contains('drug|theft|suspended|prevent', case=False, na=False)]
len(admis_off) # 30

admis_off.head()

admis_off.to_excel("output/admis.xlsx")
