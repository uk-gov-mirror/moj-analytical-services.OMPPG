...
# EDS
recalls[recalls['SENTENCE'] == 'Determinate 12 months or more']['CUSTODY_TYPE_AT_RECALL'].value_counts(dropna=False)

eds_mask = (recalls['SENTENCE'] == 'Determinate 12 months or more') & (recalls['CUSTODY_TYPE_AT_RECALL'] != 'Determinate')

sum(eds_mask)

recalls[eds_mask]['CUSTODY_TYPE_AT_RECALL'].value_counts(dropna=False)

recalls.loc[eds_mask,'SENTENCE'] = 'Extended Determinate'
