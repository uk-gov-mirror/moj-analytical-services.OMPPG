...
isp2 = pd.read_parquet("s3://alpha-omppg/isp-population/final/isp_pop_2024q2.parquet")
isp3 = pd.read_parquet("s3://alpha-omppg/isp-population/final/isp_pop_2024q4.parquet")
isp4 = pd.read_parquet("s3://alpha-omppg/isp-population/final/isp_pop_2025q1.parquet")

isp1.columns = isp1.columns.str.upper()

isp1 = isp1[['NOMIS_ID', 'SURNAME', 'FORENAME', 'OFFENCEGROUP','EXTRACTDATE']]

isp = pd.concat([isp1,isp2,isp3,isp4],ignore_index=True)
