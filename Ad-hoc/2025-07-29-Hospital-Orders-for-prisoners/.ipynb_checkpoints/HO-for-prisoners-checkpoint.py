...
sum(~matched['ACTUAL_DATE'].isna()) # 674 matches

with_48_49 = matched[~matched['ACTUAL_DATE'].isna()]
len(with_48_49) # 674

with_48_49.head(10)

# Keep only s37/41/41 with links to 48/49
with_48_49['AUTHORITY_FOR_DETENTION_DESCRIPTION'].value_counts(dropna=False)

fileReferenceWith48 = with_48_49.loc[with_48_49['AUTHORITY_FOR_DETENTION_DESCRIPTION'].str.contains('48'), 'FILE_REFERENCE'].unique()

with_48_49 = with_48_49[
    with_48_49['FILE_REFERENCE'].isin(fileReferenceWith48)
]
...
len(matched2) # 269 more than 84

matched2 = matched2[~matched2['AUTH_48'].isna()]

len(matched2) # 269 more than 39
