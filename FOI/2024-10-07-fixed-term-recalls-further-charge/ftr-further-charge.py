...
recalls = recalls[recalls['RECALL_TYPE_DESCRIPTION'] !='Indeterminate Recall']
ftr_mask = recalls['RECALL_TYPE_DESCRIPTION'].str.contains('fix|ftr', case=False)
standard = recalls[~ftr_mask]

len(standard) # 20123, 11925 
...
len(standard[standard['FURTHER_CHARGE'] == 100])
