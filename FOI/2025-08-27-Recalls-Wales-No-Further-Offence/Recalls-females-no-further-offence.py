""" 
1. Can you please provide me with the number of women in Wales recalled to custody (not involving a further offence) in 2024. 
...
3. Can you please provide me with the number of women in England recalled to custody (not involving a further offence) in 2024. 
...
recalls[further_offence_mask_1]['RECALL_REASON_DESCRIPTIONS'].size # 
recalls[further_offence_mask_2]['RECALL_REASON_DESCRIPTIONS'].size # 

noFurtherOffence = recalls[~further_offence_mask_1].copy()

len(noFurtherOffence) # 28459
...
noFurtherOffence['COUNTRY'].value_counts(dropna=False) # 26296, 2163
...
len(femalesNoFurtherOffence) #2461
