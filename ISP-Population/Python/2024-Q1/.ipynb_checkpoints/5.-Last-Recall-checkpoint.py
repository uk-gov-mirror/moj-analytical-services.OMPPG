...
#---------------------------------- Load ISP recall data

isp_recalls =  pd.read_pickle(f"~/OMPPG/Recalls/Python/ISP Releases and Recalls/{year} Q{quarter}/isp_recalls_{year}q{quarter}.pkl")
isp_recalls =  pd.read_parquet(f"~/OMPPG/Recalls/Python/ISP Releases and Recalls/{year} Q{quarter}/isp_recalls_{year}q{quarter}.parquet")
