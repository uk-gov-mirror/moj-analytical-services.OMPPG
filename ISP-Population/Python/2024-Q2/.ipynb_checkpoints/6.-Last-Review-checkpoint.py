...
gpp_ipp = pd.read_excel(f's3://alpha-omppg/isp-population/PPUD/2024Q2/PPUD_IPP_GPP_{year}Q{quarter}.xls')
gpp_life = pd.read_excel(f's3://alpha-omppg/isp-population/PPUD/2024Q2/PPUD_Life_GPP_{year}Q{quarter}.xls')
