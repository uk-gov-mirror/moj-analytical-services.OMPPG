...
isp_recalls_final = pd.read_parquet(f"s3://alpha-omppg/Recalls/final_data/Parquet/isp_recalls_{year}q{quarter}.parquet")
...
ispLastRec['DAYS_RECALLED'] = (ispLastRec['EXTRACTDATE'].dt.date - ispLastRec['LAST_RTC_DATE'].dt.date).dt.days
ispLastRec.head()
