...
ispPPUD_Matched.shape # 25222, 25147, 25052
...
ispTariffs.shape # 21775, 21444,21084
...
ispTariffs.shape # 11264, 11303,11323, 11351
...
ispTNodup.shape # 10902, 10939,10961, 10995
...
next_day = pd.Timestamp(year,12,day)+ np.timedelta64(1,'D')
next_day
