...
gpp_ipp = pd.read_excel(f's3://alpha-omppg/isp-population/PPUD/2024Q4/PPUD_IPP_GPP_{year}Q{quarter}.xls')
gpp_life = pd.read_excel(f's3://alpha-omppg/isp-population/PPUD/2024Q4/PPUD_Life_GPP_{year}Q{quarter}.xls')
...
gpp2.shape # 29375, 29474, 29421, 29616
...
gpp3.shape # 29370, 26376,26290

gpp3.loc[gpp3['SUBSEQUENT_OUTCOME_ACTUAL'].isna(),'SUBSEQUENT_OUTCOME_ACTUAL'] = gpp3['REVIEW_DATE']

gpp3.duplicated(subset=['U_SENT', 'REVIEW_DATE'], keep=False).sum() # 36
...
ispLastRev.shape # 10902, 10939, 10961
