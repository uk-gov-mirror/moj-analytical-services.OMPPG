...
# isp_releases =  pd.read_pickle("~/OMPPG/Recalls/Python/ISP Releases and Recalls/2023 Q4/isp_releases_2023q4.pkl")
isp_releases =  pd.read_parquet(f"~/OMPPG/Recalls/Python/ISP Releases and Recalls/{year} Q{quarter}/isp_releases_{year}q{quarter}.parquet")

firstRel = isp_releases[isp_releases['RELEASE_TYPE']=='First Release']
