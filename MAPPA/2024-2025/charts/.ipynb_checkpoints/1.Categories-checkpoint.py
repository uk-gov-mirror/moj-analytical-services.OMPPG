...
start_year = 2015 # changes every year
...
# You have to run everything below in one
...
# Only plot Cat1, Cat2, and Cat3 up to 2022
# Cat 4 was introduced in 2023
...
# Plot all four categories from 2023 with adjusted offsets for four bars
