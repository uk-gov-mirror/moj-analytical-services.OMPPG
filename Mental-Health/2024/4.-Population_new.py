...
year = 2024
pop = pd.read_parquet(f"s3://alpha-omppg/Mental-Health/{year}/output/population_prepared_{year}.parquet")
#--------------  breakdown all offences

    # Table 5
pd.crosstab([pop['GENDER'],pop['DETAUTH']],pop['STATUS'], margins = True, margins_name = 'Total',dropna=False).to_excel("Tables/Table_5.xlsx")
