...
index_offence['Index_Prep'] = index_offence['INDEX_OFFENCE_DESCRIPTION'].copy().str.replace(r"\(.*\)"," ",regex=True) 
index_offence['Index_Prep'] = index_offence['Index_Prep'].str.replace('[,/.)(-:’‘]', ' ',regex=True) 
index_offence['Index_Prep'] = index_offence['Index_Prep'].str.lower() # lower case
...
index_offence['Index_Prep'] = index_offence['Index_Prep'].str.replace(pat, ' ',regex=True) # remove chars
index_offence['Index_Prep'] = index_offence['Index_Prep'].copy().apply(lambda x: x.split())

home_offence['Home_Prep'] = home_offence['Detailed_offence'].str.lower().apply(lambda x: x.split())
