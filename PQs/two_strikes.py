...
two_strikes = lifers_this_year[lifers_this_year['CUSTODY_TYPE_DESCRIPTION'].isin(['Automatic','Life sentence for 2nd listed offence'])]
two_strikes['CUSTODY_TYPE_DESCRIPTION'].value_counts(dropna=False)
...
two_strikes[['CUSTODY_TYPE_DESCRIPTION','DOS']].sort_values('DOS')
