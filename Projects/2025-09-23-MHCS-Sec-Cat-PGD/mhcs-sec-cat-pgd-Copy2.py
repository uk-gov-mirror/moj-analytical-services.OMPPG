...
query = """SELECT a.*,
            ...
            ON  a.NOMS_ID = b.NOMIS_NO AND
            a.ACTUAL_DATE <= b.EXTRDATE"""
...
len(matched2) # 605 as we started with

# matched2.head()

matched2['ACTUAL_TO_POP_DATE'].max() # 435 days
sum(matched2['ACTUAL_TO_POP_DATE'] > '30 days') # 1

matched2[matched2['ACTUAL_TO_POP_DATE'] > '30 days'][['NOMS_ID','FAMILY_NAME','ACTUAL_DATE','EXTRDATE','ACTUAL_TO_POP_DATE','APPLICATION_RECEIVED_IN_MHU','AUTHORISATION_DATE','AUTHORITY_FOR_DETENTION_DESCRIPTION']]
