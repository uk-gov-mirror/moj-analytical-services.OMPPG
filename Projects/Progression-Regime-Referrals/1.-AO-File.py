...
month = str(3).zfill(2) # pads the number 3 with a leading zero
day = 31
...
pop = pd.read_csv("s3://alpha-omppg/Eric-Temp/Central Referall/Charlotte/DAO_2024_05_17.csv")
...
dateColsToChange =['DOB','DATE_OF_RELEASE','EXTRDATE','F2052_START','FIRST_CONVICTED','FIRST_MOVEMENT_DATE','FIRST_SENTENCED','SEC_CAT_ASSESSMENT_DATE','LAST_MOVEMENT_DATE']
...
# match
pop.info()
pop['EXTRACTDATE'] = pd.to_datetime(pop['EXTRACTDATE'],dayfirst=True)
