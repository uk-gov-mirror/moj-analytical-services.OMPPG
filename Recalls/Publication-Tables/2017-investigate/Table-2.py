...
rec3 = pd.read_sas('s3://alpha-omppg/Recalls/final_data/recalls/all/recalls_final_2017q3.sas7bdat',encoding='latin1')
rec4 = pd.read_sas('s3://alpha-omppg/Recalls/final_data/recalls/all/recalls_final_2017q4.sas7bdat',encoding='latin1')
rec1 = pd.read_sas('s3://alpha-omppg/Recalls/final_data/recalls/all/recalls_final_2017q1_original.sas7bdat',encoding='latin1')
rec2 = pd.read_sas('s3://alpha-omppg/Recalls/final_data/recalls/all/recalls_final_2017q2.sas7bdat',encoding='latin1')
...
recalls.pivot_table(index=['GENDER','SENTENCE'],columns='QUARTER',aggfunc='size').reset_index()[['GENDER','SENTENCE'] + quarters]
