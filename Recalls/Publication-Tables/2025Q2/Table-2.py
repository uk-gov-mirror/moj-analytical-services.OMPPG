...
rec4 = pd.read_parquet('s3://alpha-omppg/Recalls/final_data/recalls/all/recalls_final_2025q2.parquet')
...
recalls = pd.concat([rec5,rec1,rec2,rec3,rec4], ignore_index=True)
len(recalls) # 51300, 47674, 44725, 41354, 38193,35235
recalls.head()
