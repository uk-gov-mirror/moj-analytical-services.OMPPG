...
ual1 = pd.read_parquet('s3://alpha-omppg/UAL/final_data/ual_final_2025q2.parquet')
...
ual = pd.concat( [ual2,ual3,ual4,ual5,ual1], ignore_index=True)
len(ual) # 13741, 13393, 13002, 12634,12236, 11900
ual.head()
ual.info()
