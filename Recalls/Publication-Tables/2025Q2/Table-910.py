...
reas1 = pd.read_parquet('s3://alpha-omppg/Recalls/final_data/recall_reasons/recall_reasons_2025q2.parquet')
...
reasons = pd.concat([reas2,reas3,reas4,reas5,reas1], ignore_index=True)
len(reasons) # 96860,90795,80236,74661,68905
reasons.head()
reasons.info()
