...
real3 = pd.read_parquet('s3://alpha-omppg/isp_releases/final-data/isp_releases_2024q3.parquet')
real4 = pd.read_parquet('s3://alpha-omppg/isp_releases/final-data/isp_releases_2024q4.parquet')
real5 = pd.read_parquet('s3://alpha-omppg/isp_releases/final-data/isp_releases_2025q1.parquet')
real1 = pd.read_parquet('s3://alpha-omppg/isp_releases/final-data/isp_releases_2025q2.parquet')
...
releases = pd.concat([real2,real3,real4,real5,real1], ignore_index=True)
...
len(releases) # 114, 1153, 1072,1011,887,811
