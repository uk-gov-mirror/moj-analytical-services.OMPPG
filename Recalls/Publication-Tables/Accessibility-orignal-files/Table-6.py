...
recalls['RECALLED_IN_STATUS_ON'] = recalls.apply(lambda x: 'Recalled in ' + str(x['QUARTER']) + ' status as at ' + str(x['RETURN_BY_STR']), axis=1)
...
# Text to be added
header_text_t6 = [
    "Table 6: Time series: Table 5.6: Number of recalls from licence by recall process and return to custody status, England and Wales [note 3][note 4]",
