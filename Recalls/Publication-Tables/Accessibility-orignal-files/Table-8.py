...
# Text to be added
header_text_t8 = [
    "Table 8: Time series: number of offenders not returned to custody after licence recall, by supervising body and length of time since recall, England and Wales",
