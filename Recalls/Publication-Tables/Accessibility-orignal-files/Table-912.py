...
quarters = list(recalls['ETHNICITY'].unique()) # values like 'Month to Month Year'
quarters
...
# Header text
header_text_t12 = [
    "Table 12: number of recalls, by sex, sentence, supervising body and ethnicity, England and Wales [note 4]",
