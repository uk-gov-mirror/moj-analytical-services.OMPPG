...
# Text to be added
header_text_t7 = [
    "Table 7: Time series: number of offenders not returned to custody after licence recall, by sex, sentence and supervising body, England and Wales [note 2] [note 6]",
