...
final_summary_df['Recall category'] = final_summary_df['Recall category'].astype(CategoricalDtype(categories=hdc_values, ordered=True))
...
final_pivot_df = final_pivot_df[['Sex', 'Sentence type', 'Recall category'] + quarters]
...
contents_sheet = workbook.create_sheet(title='Contents')
