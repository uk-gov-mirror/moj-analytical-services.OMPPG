...
remove_mask = (recalls['NOMS_ID']=='A5886AT') &(recalls['LICENCE_REVOKE_DATE']==pd.Timestamp(2017,2,17))

sum(remove_mask)
recalls[remove_mask]

recalls = recalls[~remove_mask].copy()
...
recalls.pivot_table(index='RECALL_TYPE_DESCRIPTION',columns = 'YEAR',aggfunc='size')
"""
recalls.head()
recalls.tail()
