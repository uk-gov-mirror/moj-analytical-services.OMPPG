...
releases = pd.read_pickle(f'isp_releases_{year}q{quarter}_step1.pkl')
...
isp_releases_final.to_parquet(f"isp_releases_{year}q{quarter}.parquet")
isp_releases_final.to_pickle(f"isp_releases_{year}q{quarter}.pkl")
