...
for column in dateColsToChange:
    recallsPPUD.loc[recallsPPUD[column].astype(str).str.contains('2997'), column] = recallsPPUD[column].str.replace('2997','2007', regex=True)
