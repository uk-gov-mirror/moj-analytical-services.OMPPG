...
recallsPPUD.info() # 10176, 9906

    # Convert columns that should be datetime to datetime
dateColsToChange =['ISSUE_REVOCATION_TARGET','REPORT_RECD_BY_UNIT_ACTUAL']
...
Recalls_Matched.shape # 10176, 9905
...
recalls_nodup.shape # 10162, 9891
