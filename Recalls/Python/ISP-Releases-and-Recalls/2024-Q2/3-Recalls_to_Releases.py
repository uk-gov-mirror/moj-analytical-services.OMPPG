...
Releases_final2 = prepareMatch.prepareMatch(Releases_final2)
recalls_nodup = prepareMatch.prepareMatch(recalls_nodup)

    # drop the length variables
Releases_final2.drop(['PN_LENGTH','NOMS_LENGTH'],axis=1,inplace = True)
...
recall_to_release.shape #16315,15905
...
recall_to_release.shape # 16310, 15900
...
recall_to_release2.shape #17139, 16707
...
isp_releases_final.shape #16310,15900
...
isp_releases_final.head(20)

isp_releases_final.to_parquet(f"s3://alpha-omppg/ISP Releases/Final Data/isp_releases_{year}q{quarter}.parquet",index=False)
