...
release_to_recall.shape # 10180,9909
...
release_to_recall.shape # 10162,9891
...
release_to_recall2.shape # 16647,16002
...
release_to_recall2.shape # 10162, 9891
...
release_to_recall3.shape # 10190,9916
...
release_to_recall3.shape # 10162, 9891
...
isp_recalls_final.shape # 10162, 9891

isp_recalls_final.head()

#---------------------------------- Save to Amazon

isp_recalls_final.to_parquet(f"s3://alpha-omppg/Recalls/final_data/Parquet/isp_recalls_{year}q{quarter}.parquet",index=False)
