...
releases.shape  # 20947, 20413,20055
...
releases_extra.shape # 17562,170,053,16700,16282

releases_matched = pd.concat([releases_extra,relsMatched2013,relsMatched2014,relsMatched2015],
                             axis = 0,
                             ignore_index=True) # 

releases_matched.shape # 20987,20453,20095, 19675
...
releases_matched[releases_matched['MATCH'] ==1].head(10)[['NOMIS_NO','NOMS_ID','NOMS_TRIM','NOMS_END',
...
releases_matched.shape # 20836, 20308,19952, 19539
...
Releases_final2.shape # 20699,20170,19816, 19404
