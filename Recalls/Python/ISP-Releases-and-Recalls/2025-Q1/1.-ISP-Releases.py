...
releases_extra.shape # 18209, 17562,170,053,16700,16282

releases_matched = pd.concat([releases_extra,relsMatched2013,relsMatched2014,relsMatched2015],
                             axis = 0,
                             ignore_index=True) # 

releases_matched.shape # 21645, 20987,20453,20095, 19675
...
releases_matched[releases_matched['MATCH'] ==1].head(10)[['NOMIS_NO','NOMS_ID','PRISON_NUMBER',
                           'FAMILY_NAME','SURNAME_DIS','DOB','DOB_DIS',
                           'INIT','INIT_DIS','RELEASE_DATE','DATEDIS','MATCH']]
...
releases_matched.shape # 21423, 20836, 20308,19952, 19539
...
Releases_final.shape # 20693, 20165,19811,19399
...
Releases_final2.shape # 21286, 20699,20170,19816, 19404
...
Releases_final2['RELEASE_DATE'].min() # 2010
