...
recalls.shape,extras.shape #((7417,7415),(7157, 7152))
...
recalls = recalls.drop(index=[17,5704]) # stopped/deceased
...
#correction
extras.loc[extras['FILE_REFERENCE']=='PPU_398491']
extras.loc[extras['FILE_REFERENCE']=='PPU_398491','LICENCE_REVOKE_DATE'] = pd.Timestamp(2024,3,1,15,54,0)
query = """SELECT a.*, 
                  b.DOS, 
...
recalls_pub.shape # 7415 no dups
...
# recalls_final.to_parquet(f"s3://alpha-omppg/Recalls/final_data/Parquet/recalls_final_{year}q{quarter}.parquet",index=False)
