...
# to remove - specific cases brought to light for removal (known returns or deceased cases)
ual[ual['PRISON_NUMBER'].isin(['84903A','74367F'])]

ual = ual[~ual['PRISON_NUMBER'].isin(['84903A','74367F'])]

ual.shape # 2715, 2620, 2507, 2416

ual =ual[~ual['LICENCE_REVOKE_DATE'].isna()]
ual.head()

ual = ual.drop(['Unnamed: 34','Unnamed: 35'],axis=1)
ual.shape
...
ual_matched.shape #3428, 3309,3169
