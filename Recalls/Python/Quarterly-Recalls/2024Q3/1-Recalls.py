...
recalls.shape # 9975,9782,7417,7157
extras[extras['RESCIND_FLAG'] == False].shape # 9966
extras.shape # 10123, 9906 (now contains rescinded to cover all), 9775,7415,7152
...
recalls.loc[[997,6750]]

recalls.loc[[997,6750],'RTC_DATE'] = pd.NaT
...
recalls_pub.shape # 9975,9782, 7415 no dups
...
extras.loc[extras['FILE_REFERENCE'] == 'PPU_424376'][['FILE_REFERENCE', 'PRISON_NUMBER', 'FAMILY_NAME', 'LICENCE_REVOKE_DATE', 'RTC_DATE', 'RECALL_TYPE_DESCRIPTION']] # 0

extras.loc[[4897],'LICENCE_REVOKE_DATE'] = recalls_pub.loc[[8191]]['LICENCE_REVOKE_DATE'].iloc[0]

    # check some rescinded cases in extra
    
recalls_pub[recalls_pub['RESCIND_FLAG_2'] == True][['FILE_REFERENCE', 'PRISON_NUMBER', 'FAMILY_NAME', 'LICENCE_REVOKE_DATE', 'RTC_DATE', 'RECALL_TYPE_DESCRIPTION','UAL_FLAG']] # 9
...
recalls_matched.shape # 9975, 9782,7415
