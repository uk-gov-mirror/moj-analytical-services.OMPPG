...
recalls.shape # 10407, 9975,9782,7417,7157
extras.shape # 10522,10123, 9906 (now contains rescinded to cover all), 9775,7415,7152
extras[extras['RESCIND_FLAG'] == False].shape # 9966
...
recalls.loc[[985, 5851, 7235, 8892, 9837, 10080, 10266]]

recalls.loc[[985, 5851, 7235, 8892, 9837, 10080, 10266],'RTC_DATE'] = pd.NaT
...
recalls[recalls['FAMILY_NAME'].str.contains('Case|Lumen',case = False,na = False)][['FILE_REFERENCE','FAMILY_NAME','FIRST_NAMES']] # 0

recalls[recalls['FIRST_NAMES'].str.contains('Case|Lumen',case = False,na = False)][['FILE_REFERENCE','FAMILY_NAME','FIRST_NAMES']] # 0
...
recalls_pub[recalls_pub['RECALL_REASON_DESCRIPTIONS'].isna()][['FILE_REFERENCE', 'PRISON_NUMBER', 'FAMILY_NAME', 'LICENCE_REVOKE_DATE', 'RTC_DATE', 'RECALL_TYPE_DESCRIPTION','EXTRAS_FAMILY_NAME','PN']] # 0

    # Remove recalls that should not have happened - legal grounds, errors before check date
    
recalls_pub[recalls_pub['RESCIND_FLAG_2'] == True][['FILE_REFERENCE', 'STOPPED_REASON_DESCRIPTION','PRISON_NUMBER', 'FAMILY_NAME', 'LICENCE_REVOKE_DATE', 'RTC_DATE', 'RECALL_TYPE_DESCRIPTION','RESCIND_FLAG','UAL_FLAG']] # 10

show_data(recalls_pub.loc[[10,1408,2325,8980,9637,10278]][['FILE_REFERENCE', 'STOPPED_REASON_DESCRIPTION','PRISON_NUMBER', 'FAMILY_NAME', 'LICENCE_REVOKE_DATE', 'RTC_DATE', 'RECALL_TYPE_DESCRIPTION','RESCIND_FLAG','UAL_FLAG']])

recalls_pub = recalls_pub.drop(index =[10,1408,2325,8980,9637,10278])
len(recalls_pub) # 10401
...
recalls_matched.shape # 10401, 9975, 9782,7415
